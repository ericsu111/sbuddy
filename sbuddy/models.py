...
class Profile(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if self.phone_number:
            account_sid = 'ACcbf1b53b4f4f0d9bbb92a1304d3aaa76'#os.environ['TWILIO_ACCOUNT_SID']#'ACcbf1b53b4f4f0d9bbb92a1304d3aaa76'os.environ['TWILIO_ACCOUNT_SID']
            auth_token = 'ec8302fef58f3ebf9ddead86fb8ea18d'#os.environ['TWILIO_AUTH_TOKEN']#'ec8302fef58f3ebf9ddead86fb8ea18d'#os.environ['TWILIO_AUTH_TOKEN']
            client = Client(account_sid, auth_token)
            message = client.messages.create(
                                            body="Your settings have been updated" + self.name + self.availability + ".",
                                            from_='+13157549860',
